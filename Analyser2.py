...
file_path = "C:\\Users\\SBihan\\Desktop\\Theremino\\SpectrumFile_001.txt"

# Load the data from the file, skipping the header lines
data = np.loadtxt(file_path, skiprows=2)
    
def integrate_intensity(start_wavelength, end_wavelength):
    """
...
def integrate_photon_energy(start_wavelength, end_wavelength):
    """
...
visible_light_photons = integrate_intensity(380, 750)
visible_light_energy = integrate_photon_energy(380, 750)

blue_light_photons = integrate_intensity(380, 495)
blue_light_energy = integrate_photon_energy(380, 495)

ir_photons = integrate_intensity(750, 1180)
ir_energy = integrate_photon_energy(750, 1180)
